...
plot(pwr_cons2$datetime,pwr_cons2$Voltage, type='l', 
...
legend('topright', legend=c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'),
       col=c('black', 'red', 'blue'),bty='n' ,lty=1,  seg.len=0.5) 


plot(pwr_cons2$datetime,pwr_cons2$Global_reactive_power, type='l', 
